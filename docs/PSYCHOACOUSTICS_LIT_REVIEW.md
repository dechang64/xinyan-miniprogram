...
## 0. 心颜 5 滋养曲风 v1.0 强化方案 (综合 v1 + v2)

| 调式 | 五行 | 五脏 | 心理感受 (百度文库) | 西方大调类比 | 心颜"滋养" 描述 | BPM | 5 音 Hz | 建议乐器 (Howard) |
|---|---|---|---|---|---|---|---|---|
...
- **§5 基音感知**: **缺失基频 (Missing Fundamental)** = 心颜"滋养" 心理基础 (单耳可感知基频, 不依赖物理)
- **§7 鸡尾酒会效应**: 心颜共修堂多人场景, 5 段音乐需**频谱不重叠** 避免互相掩蔽

### 1.2 Moore §3 频率选择性 (Fletcher 1940 + Glasberg & Moore 1990)

**新增**:
- **ERB (Equivalent Rectangular Bandwidth)** = 等效矩形带宽, 1 ERB ≈ 0.108 × f + 24.7 Hz
  - 440 Hz → ERB ≈ 72 Hz (心颜 A4 临界带宽)
  - 660 Hz → ERB ≈ 96 Hz
...
**对心颜 5 曲风**:
- ✅ 心颜 5 音**全部 < 1.5 kHz**, ERB-rate 1-9 (舒适区)
...
- **心颜应用**: 5 段音乐若采用**纯音/简单谐波** (而非白噪声), 听者会自动"补全"基频 → 心理"完整度"
- **心颜 5 音 440-659 Hz** = 即使高频泛音被掩蔽/衰减, 听者仍"感知"基频 → 心理稳定性
...
- **心颜共修堂多人场景** (5-10 人), 5 段音乐若频率相近, 会**融合成噪声**
...
3. **操作要点** (§7):
   - **初始音量 25 dB** (背景)
   - **治疗音量 25-60 dB** (心颜 5 段音乐上限 60 dB ✅ 跟规范一致)
   - 治疗结束 **休息 5-10 分钟**
   - **记录血压/脉搏/主观感受**
   - 每日治疗室通风消毒

**对心颜 v1.0 应用**:
- 心颜 v1.0 共修堂空间设计 = **T/CRHA036—2024 §5 治疗室布局** (12-20m², 18-22℃, 50-60% 湿度)
- 心颜 5 段音乐音量 = **T/CRHA036—2024 §7.3.4 25-60 dB**
- 心颜 5 曲风映射 = **T/CRHA036—2024 §6.1 五行-五脏-五音** (已有)
- **心颜 v1.0 PRD §7 应增补"心颜共修堂 卫生/通风/室温" 规范** (跟 T/CRHA036—2024 同步)
...
- ⚠️ **现有研究质量偏低** (于姚 2020 也承认) — 心颜 v1.0 5000 用户时**可启动心颜 RCT** 提升证据等级
- 心颜"滋养/共修"定位 = **非医疗性 5 调式音乐应用**, 不在"治疗"范畴, 不需要医学证明
...
**对心颜**:
- 5 元素音乐 + **放松训练** (心颜"心颜共修堂" 3 任务之一) → 抑郁/焦虑缓解
- 心颜 v1.0 可加"5 段音乐 + 30 天呼吸训练" 联合方案 (类似 PMRT)
...
- ✅ 心颜"听滋养" 模式 (非治疗师介入) **符合循证医学** ✅
- ⚠️ **6 周以上效果最佳** → 心颜 v1.0 至少 6 周留住用户才显现效果
- 心颜 30 天曲线 = **早期指标 (前 6 周 vs 后 6 周)**
...
- **心颜定位**: v0.7 prototype 单纯听音乐 + 镜中自评, 无治疗师 → **符合 PLOS ONE 路线**
- 心颜 v1.0 可加 **可选"心颜音疗师" 1v1 视频通话** (高净值用户) → **两者结合最大效果**
...
### 3.3 心颜 5 调式 三维映射表 (终极版)

| 调式 | 五行 | 五脏 | 心理感受 (百度文库) | 西方大调类比 | 心颜"滋养" | BPM | 5 音 Hz | 频谱质心 | 建议乐器 | ADSR |
|---|---|---|---|---|---|---|---|---|---|---|
...
## 4. 关键心颜 v0.7.1.9 增量 (v1 笔记 + v2 综述)

### 4.1 心颜 5 段音乐 v1.0 重生成指导 (T/CRHA036—2024 合规)
...
### 4.2 心颜共修堂空间 v1.0 (T/CRHA036—2024 合规)
...
3. **心颜 v1.0 临床证据** v0.7.1.7.5 (5 调式 + CD 音乐) 是否需要在 PRD 引用 Liao 2018 + 于姚 2020 + Music Meta 2020?
...
- **心理声学 + 临床 Meta 分析 + 5 行音乐国家标准** = 心颜 v1.0 学术护城河完整
- **三维映射** (五行-西方大调-心理声学) 解决"五行哲学 vs 西方音乐 vs 硬科学" 的统一问题
- **T/CRHA036—2024** 是中国唯一**国家标准级** 5 元素音乐护理规范, 心颜 v1.0 应明确引用
- **Music Therapy Meta 2020 SMD=-1.33** (音乐医学) > **SMD=-0.66** (治疗师介入) — 心颜"无治疗师单纯听" 路线有 **Level A 循证证据**
...
| 心颜 v0.7.1.7.8-r8 海报路线 | + 心颜 v1.0 共修堂空间规范 (12-20m², 18-22℃, 50-60% 湿度) |
