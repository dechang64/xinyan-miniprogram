# 悦济 5 段滋养曲风 v1.0 规范 (Music V1.0 Spec)
...
> 5 段音乐来源: 悦济当前用 v0.7.1.7.5-r3 (data/music.py) → **重生成 v1.0 规范版**
...
| 参数 | 值 | 依据 |
|---|---|---|
| **采样率** | 44100 Hz | CD 音质, Nyquist 22050 Hz (覆盖悦济 5 音最高 659 Hz × 5 谐波 = 3295 Hz) |
| **位深** | 16-bit | CD 标准 |
...
### 3.2 适配悦济 v1.0 规范的曲目 (待 user 试听筛选)
...
## 4. 悦济 v1.0 共修堂空间规范 (T/CRHA036—2024 §5)
...
| **声学参数** | RT60 ≤ 0.5 秒 (悦济 v0.7.1.9 笔记, Howard §7.1) | |

---

## 5. 悦济 v1.0 评估规范 (T/CRHA036—2024 §7.4 + Howard §7.3)
...
## 6. 悦济 v1.0 PRD §7 增补建议 (给 user 拍板)
...
- **悦济 5 段音乐 v1.0 = 中医哲学 + 西方大调 + 心理声学 + 临床循证 + 国家标准** 5 维合一
- **T/CRHA036—2024** 是悦济共修堂空间唯一国家标准级依据
- **Music Meta 2020 SMD=-1.33** 证明"无治疗师单纯听" 路线有 Level A 证据
- **5 段音乐 + 共修堂空间 + 评估规范 = 悦济 v1.0 学术护城河** 完整
...
2. **悦济 v1.0 PRD §7** 是否加 T/CRHA036—2024 共修堂空间规范 + 评估规范?
